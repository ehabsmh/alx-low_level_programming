...
# compile and assemble all .c files without linking
gcc -c *.c -fpic

# remove main.o since we don't want it in our dynamic library
rm main.o

# create the dynamic library and include all the object files in it
