...
void display_version(unsigned char *e_ident);
void display_obi(unsigned char *e_ident);
...
/**
 * display_magic - Prints the magic numbers of an ELF head.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
...
/**
 * display_class - Prints the class of an ELF head.
...
/**
 * display_data - Prints the data of an ELF head.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void display_data(unsigned char *e_ident)
{
...
/**
 * display_version - Prints the version of an ELF head.
...
/**
 * display_obi - Prints the OS/ABI of an ELF head.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void display_obi(unsigned char *e_ident)
{
...
/**
 * display_version - Prints the ABI version of an ELF head.
...
/**
 * display_type - Prints the type of an ELF head.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void display_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * display_entry - Prints the entry point of an ELF head.
